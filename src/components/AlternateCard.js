        ...
        <div>
          <a href="#!" title={blog && blog.title ? blog.title : ""} >
            <div className="post-listing-img nopin" style={{ backgroundImage: `url(${blog && blog.image ? blog.image : ""})` }}>
              <div className="left-right-date left-date">
                <time dateTime={dateTime}>{dateTime}</time>
              </div>
              <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAWgAAAHgAQMAAACyyGUjAAAAA1BMVEUAAACnej3aAAAAAXRSTlMAQObYZgAAACxJREFUeNrtwTEBAAAAwiD7p7bGDmAAAAAAAAAAAAAAAAAAAAAAAAAAAAAkHVZAAAFam5MDAAAAAElFTkSuQmCC" alt="“LUXURY” SKINCARE ROUTINE" class="p3_invisible" ></img>
            </div>
          </a>
        </div>
      </div>
